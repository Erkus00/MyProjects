...
import static controller.ProductoDAO.carta;
import static controller.ProductoDAO.infoProducto;
...
public class PedidoDAO {
    ...
    public static boolean insertarPedido(Pedido pedido) {
        ...
        pedido.getHashProductos().forEach((k, v) -> {
            if (v > 0) {
     ...
     */
    public static ArrayList<Pedido> listarPedidosFecha(java.sql.Date fechaInicio, java.sql.Date fechaFin) {
    ...
    public static ArrayList<Pedido> listarAllPedidosOrdenados() {
        ArrayList<Pedido> listado_pedidos = new ArrayList<>();
        ArrayList<Integer> info_identificador = new ArrayList<>();
        String sql_query = "";
        sql_query = "SELECT DISTINCT identificador FROM pedido ORDER BY fecha ASC";
